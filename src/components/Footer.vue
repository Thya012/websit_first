<template>
  <footer id="contact-section" class="g-pos-rel">
        ...
        <!-- Go To Top -->
        <a class="js-go-to text-center g-color-main g-color-primary--hover g-left-50x g-ml-minus-100 animated js-animation-was-fired fadeInUp" href="#!" data-type="absolute" data-position="{
             &quot;bottom&quot;: 65
           }" data-offset-top="400" data-compensation="#js-header" data-show-effect="fadeInUp" style="display: inline-block; position: absolute; bottom: 65px;">
